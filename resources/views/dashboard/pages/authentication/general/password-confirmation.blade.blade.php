		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/development-hd.png)">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-20">
					<!--begin::Logo-->
					<a href="../..//dist/index.html" class="mb-10 pt-lg-20">
					...
					<div class="pt-lg-10">
						...
						<div class="text-center">
							<a href="../..//dist/authentication/flows/basic/sign-in.html" class="btn btn-primary btn-lg fw-bolder">Sign In</a>
						</div>
						<!--end::Action-->
						<!--begin::Action-->
						<div class="text-gray-700 fw-bold fs-4 pt-7">Did’t receive an email?
						<a href="../..//dist/authentication/flows/basic/password-reset.html" class="text-primary fw-bolder">Try Again</a></div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
				</div>
