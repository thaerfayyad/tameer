		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid pt-20">
				...
				<div class="d-flex flex-column flex-center p-10 p-lg-20">
					<!--begin::Logo-->
					<a href="../..//dist/index.html" class="mb-20">
					...
					<!--end::Counter-->
					<!--begin::Description-->
					<div class="fw-bolder fs-2 text-muted mb-5">Get notified when we Launch!</div>
					<!--end::Description-->
					<!--begin::Form-->
				...
				<!--end::Content-->
				<!--begin::Illustration-->
				<div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-position-y-top bgi-size-cover min-h-100px min-h-lg-250px opacity-75" style="background-image: url(assets/media/illustrations/portfolio.png)"></div>
				<!--end::Illustration-->
			</div>
