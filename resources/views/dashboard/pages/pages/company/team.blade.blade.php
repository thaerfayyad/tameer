									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div class="menu-item">
													<a class="menu-link active" href="../..//dist/pages/company/team.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
																...
																<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div class="menu-item">
																		<a class="menu-link active py-3" href="../..//dist/pages/company/team.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Our Team</span>
											...
											<div class="mb-11">
												...
												<div class="overlay">
													...
													<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
														<a href="../..//dist/pages/company/pricing.html" class="btn btn-primary">Pricing</a>
										...
										<div class="mb-18">
											...
											<div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Paul Miles</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Jania Garnbet</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">James Nilson</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Mia Miles</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Sophia Miles</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Oliver Lucas</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Amelia Miles</a>
														<!--end::Name-->
														<!--begin::Position-->
												...
												<div class="col text-center mb-9">
													...
													<div class="mb-0">
														<!--begin::Name-->
														<a href="../..//dist/pages/profile/projects.html" class="text-dark fw-bolder text-hover-primary fs-3">Liam James</a>
														<!--end::Name-->
														<!--begin::Position-->
														<div class="text-muted fs-6 fw-bold">QA Managers</div>
														<!--begin::Position-->
