								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div class="menu-item">
													<a class="menu-link active" href="../..//dist/pages/careers/list.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
																...
																<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	<div class="menu-item">
																		<a class="menu-link active py-3" href="../..//dist/pages/careers/list.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Careers List</span>
										...
										<div class="d-flex flex-column flex-lg-row mb-17">
											...
											<div class="flex-lg-row-fluid me-0 me-lg-20">
												...
												<div class="mb-17">
													...
													<!--end::Accordion-->
													<!--begin::Apply-->
													<a href="../..//dist/pages/careers/apply.html" class="btn btn-sm btn-primary mt-5">Apply Now</a>
													<!--end::Apply-->
												</div>
												<!--end::Job-->
												<!--begin::Job-->
											...
											<div class="flex-lg-row-auto w-100 w-lg-275px w-xxl-350px">
												...
												<div class="card bg-light">
													...
													<div class="card-body">
														...
														<!--end::Item-->
														<!--begin::Link-->
														<a href="../..//dist/pages/blog/post.html" class="link-primary fs-6 fw-bold">Explore More</a>
														<!--end::Link-->
													</div>
													<!--end::Body-->
												</div>
													...
													<div class="card-xl-stretch me-md-6">
														...
														<div class="m-0">
															...
															<div class="fs-6 fw-bolder">
																<!--begin::Author-->
																<a href="../..//dist/pages/projects/users.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
																<!--end::Author-->
																<!--begin::Date-->
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch mx-md-3">
														...
														<div class="m-0">
															...
															<div class="fs-6 fw-bolder">
																<!--begin::Author-->
																<a href="../..//dist/pages/projects/users.html" class="text-gray-700 text-hover-primary">Cris Morgan</a>
																<!--end::Author-->
																<!--begin::Date-->
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch ms-md-6">
														...
														<div class="m-0">
															...
															<div class="fs-6 fw-bolder">
																<!--begin::Author-->
																<a href="../..//dist/pages/projects/users.html" class="text-gray-700 text-hover-primary">Carles Nilson</a>
																<!--end::Author-->
																<!--begin::Date-->
