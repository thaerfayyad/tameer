							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active" href="../..//dist/apps/subscriptions/list.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<a class="menu-link active py-3" href="../..//dist/apps/subscriptions/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Subscription List</span>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
												...
												<a href="../..//dist/apps/subscriptions/add.html" class="btn btn-primary">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
											...
											<tbody class="text-gray-600 fw-bold">
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="../..//dist/apps/subscriptions/add.html" class="menu-link px-3">View</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="../..//dist/apps/subscriptions/add.html" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
												...
												<tr>
													...
													<!--begin::Customer=-->
													<td>
														<a href="../..//dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
													</td>
													<!--end::Customer=-->
													<!--begin::Status=-->
													<td>
