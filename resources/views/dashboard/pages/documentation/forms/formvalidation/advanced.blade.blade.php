							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link active py-2" href="../..//dist/documentation/forms/formvalidation/advanced.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="../..//dist/documentation/forms/image-input.html" target="_blank">our documentation page</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;!--end::Form--&gt;</code>
									...
									<div class="py-10">
										...
										<a href="../..//dist/documentation/forms/password-meter.html" target="_blank">our documentation page</a>.</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
