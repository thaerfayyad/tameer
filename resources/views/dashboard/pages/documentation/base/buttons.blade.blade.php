					...
					<div class="docs-aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y mt-5 mb-5 mt-lg-0 mb-lg-5 pe-lg-n2 me-lg-2" id="kt_docs_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_docs_aside_logo" data-kt-scroll-wrappers="#kt_docs_aside_menu" data-kt-scroll-offset="10px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_docs_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active py-2" href="../..//dist/documentation/base/buttons.html">
...
&lt;a href="#" class="btn btn-active-icon-gray-900 btn-active-text-gray-900"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;Gray-900&lt;/a&gt;</code>
									...
									<div class="py-10">
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../..//dist/documentation/general/icons/duotone.html" class="fw-bold">Duotone Svg Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;span class="svg-icon svg-icon-1"&gt;&lt;svg&gt;...&lt;/svg&gt;&lt;/span&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../..//dist/documentation/general/icons/bootstrap-icons.html" class="fw-bold">Bootstrap Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="bi bi-chat-square-text-fill fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../..//dist/documentation/general/icons/font-awesome.html" class="fw-bold">Font Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
...
&lt;a href="#" class="btn btn-icon btn-dark"&gt;&lt;i class="fas fa-envelope-open-text fs-4 me-2"&gt;&lt;/i&gt;&lt;/a&gt;</code>
										...
										<!--begin::Block-->
										<div class="py-5">Use
										<a href="../..//dist/documentation/general/icons/line-awesome.html" class="fw-bold">Line Awesome Icons</a>&#160;in conbination with buttons as shown below:</div>
										<!--end::Block-->
										<!--begin::Block-->
										<div class="py-5">
											<div class="rounded border p-10">
